...
public class LectorCodigoDeBarras extends AppCompatActivity implements BarcodeReaderFragment.BarcodeReaderListener {
    ...
    public static Intent getLaunchIntent(Context context, boolean autoFocus, boolean useFlash) {
        Intent intent = new Intent(context, LectorCodigoDeBarras.class);
